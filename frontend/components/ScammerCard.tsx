...
export default function ScammerCard({ scammer }: ScammerCardProps) {
  ...
  const handleCardClick = () => {
    router.push(`/scammer/${scammer.githubUsername}`);
  };

  return (
    <div 
      onClick={handleCardClick}
      className="bg-base-200 backdrop-blur-sm rounded-xl border border-error/50 p-6 hover:border-error transition-all relative overflow-hidden cursor-pointer"
    >
